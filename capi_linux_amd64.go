// Code generated by 'ccgo -o nk_linux_amd64.go nuklear/nuklear.c -export-externs X -export-fields  -export-defines  -export-enums  -export-typedefs  -export-structs  -nostdlib -pkgname nk', DO NOT EDIT.
